...
bun x create-seed@latest -t gh:beeman/cangu-finance
```
...
```bash
git clone https://github.com/beeman/cangu-finance.git my-app
cd my-app
bun rename
bun install
```
...
| `CORS_ORIGINS`                 | Comma-separated list of allowed origins for CORS | `http://localhost:3001,cangu-finance://`        |
